...
<body>
    <div id="arribaUsuario" class="contenedor">
        ...
        <div class="arriba">
            <div class="login2">
                <form action="ARegistroGranjero.php" method="POST">
                    <table>
                        <?php
                ...
                <div class="Datos-Pag2">
                    <form class="formAdmin" action="" method="POST">
                        <table class="tablaAdmin">
                            ...
                            <tr class="trFormularioAdmin">
                                ...
                                <td class="tdFormAdmin"> <input class="inputFormAdmin" type="text" name="txtApellido"
                                        required></td>

                            </tr>
                            <tr class="trFormularioAdmin">
                                <td class="tdFormAdmin"> <label class="labelForm" for="">Rut: </label> </td>
                                <td class="tdFormAdmin"> <input class="inputFormAdmin" type="text" name="txtRut"
                                        required>
                                </td>
                            ...
                            <tr class="trFormularioAdmin">
                                ...
                                <td class="tdFormAdmin"> <input class="inputFormAdmin" type="text" name="txtTelefono"
                                        required></td>
                                <td class="tdFormAdmin"> <label class="labelForm" for="">Direccion: </label> </td>
                                <td class="tdFormAdmin"> <input class="inputFormAdmin" type="text" name="txtDireccion"
                                        required></td>
                    ...
                    <?php
                            if(isset($_POST['registrarGranjero'])){
                                ...
                                $sql = "INSERT INTO granjero (Nombre, Apellido, Rut, Edad, Direccion, Telefono, Granja_idGranja, clave) VALUES ('".$nombre."','".$apellido."','".$rut."','".$edad."','".$direccion."','".$telefono."','".$granjaS."','".$clave."')";
